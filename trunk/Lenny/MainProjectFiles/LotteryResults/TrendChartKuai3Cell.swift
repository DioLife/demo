...
class TrendChartKuai3Cell: UITableViewCell {
...
//        contentView.isSkeletonable = true
        ...
        periodWH = (screenWidth - periodHeaderW) / CGFloat(6)
        
        label_Title.whc_Top(0).whc_Left(0).whc_Height(periodWH).whc_Width(periodHeaderW).whc_Bottom(0)
