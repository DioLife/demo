//
//  QueryResultsWeiKaiJiangController.swift
//  gameplay
//
...
class QueryResultsWeiKaiJiangController: QueryResultsBasicController {
    ...
    func loadNetRequest(isLoadMoreData: Bool,pageSize: Int = defaultCountOfRequestPagesize) {
        ...
        LennyNetworkRequest.obtainLotteryQuery(lotteryCode: self.filterLotCode, startTime: self.filterStartTime, endTime: self.filterEndTime, qihao: "", version: "", order: "", zuihaoOrder: "", status: "1", queryType: "1", playCode: "", include: "1", username: self.filterUsername,pageSize: "\(pageSize)",pageNumber: "\(pageNumber)") { (model) in
