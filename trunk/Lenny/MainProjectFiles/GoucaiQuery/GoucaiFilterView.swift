...
//    private let textField = UITextField()
    ...
    private let textField_UserName = CustomFeildText()
    ...
    convenience init(height: CGFloat,controller:UIViewController) {
        ...
        setViewBackgroundColorTransparent(view: textField_UserName)
        textField_UserName.font = UIFont.systemFont(ofSize: 14)
        textField_UserName.layer.theme_borderColor = "FrostedGlass.Touzhu.separateLineColor"
        ...
        button_Selecter.whc_Top(5, toView: textField_UserName).whc_RightEqual(textField_UserName).whc_Width(200).whc_Height(30)
...
//        button_Selecter.layer.theme_borderColor = "FrostedGlass.Touzhu.separateLineColor"
...
//        button_dateEnd.layer.theme_borderColor = "FrostedGlass.Touzhu.separateLineColor"
...
//        button_dateStart.layer.theme_borderColor = "FrostedGlass.Touzhu.separateLineColor"
