...
class LotCodeFilterSelectView: UIView {
    ...
    var didSelected: ( ( Int, AllLotteryTypesSubData) -> Void)?
    ...
    convenience init(dataSource: [AllLotteryTypesSubData], viewTitle: String) {
...
extension LotCodeFilterSelectView: UITableViewDelegate {
...
extension LotCodeFilterSelectView: UITableViewDataSource {
