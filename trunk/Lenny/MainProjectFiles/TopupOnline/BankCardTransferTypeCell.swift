//
//  BankCardTransferTypeCell.swift
//  gameplay
//
...
class BankCardTransferTypeCell: UITableViewCell {
    var isSelect = false
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        button_Select.setTitle("网银转账", for: .normal)
    ...
    private func showSelectedView() {
        ...
        let selectedView = LennySelectView(dataSource: kLenny_TransferTypes, viewTitle: "转账类型选择")
