//
//  RegistrationManagementTypeSelectCell.swift
//  gameplay
//
...
class RegistrationManagementTypeSelectCell: UITableViewCell {
    ...
    func cellTransferType() -> (Int, String) {
        ...
        return (selectedIndex, kLenny_RegistrationTypes[selectedIndex])
    }
    ...
    private func showSelectedView() {
        ...
        let selectedView = LennySelectView(dataSource: kLenny_RegistrationTypes, viewTitle: "请选择用户类型")
