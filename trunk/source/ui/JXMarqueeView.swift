...
public class JXMarqueeView: UIView {
    ...
    override open func layoutSubviews() {
        ...
        let labelWidth = validContentView.bounds.size.width > 4000 ? 4000 : validContentView.bounds.size.width
        var labelFrame = validContentView.frame
        labelFrame = CGRect(x: 0, y: 0, width: labelWidth, height: self.bounds.size.height)
        validContentView.frame = labelFrame
        ...
        if marqueeType == .reverse{
            ...
            let labelWidth = containerView.bounds.size.width > 4000 ? 4000 : containerView.bounds.size.width
            var labelFrame = containerView.frame
            labelFrame = CGRect(x: 0, y: 0, width: labelWidth, height: self.bounds.size.height)
            containerView.frame = labelFrame
        }
