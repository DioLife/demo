...
extension DetailListDialog: UITableViewDelegate {
...
extension DetailListDialog: UITableViewDataSource {
...
//        }
        ...
        cell?.whc_AddBottomLine(0.5, color: UIColor.cc_224())
