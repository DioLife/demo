...
class NewSportTableContainer {
     ...
     * @return
     */
    static func fillBasketBallMN(item:Dictionary<String,AnyObject>,columns:Int,gameCategory:String) -> [NewSportBean] {
        var lists = [NewSportBean]()
    ...
    public static func fillSportResultData(item:Dictionary<String,AnyObject>,ballType:Int,playCategory:String,
                                           columns:Int,gameCategory:String) -> [NewSportBean]{
        if ballType == FOOTBALL_PAGE{
            switch playCategory{
            case FT_MN,FT_MX:
     ...
     * @return
     */
    static func fillBasketBallMX(item:Dictionary<String,AnyObject>,columns:Int,gameCategory:String) -> [NewSportBean] {
        var lists = [NewSportBean]()
        let gidValue = item.keys.contains(gid) ? item[gid] as! String : ""
        let matchIdValue = item.keys.contains(matchId) ? item[matchId] as! String : ""
        let leagueValue = item.keys.contains(league) ? item[league] as! String : ""
     ...
     * @return
     */
    static func fillFootBallHF(item:Dictionary<String,AnyObject>,columns:Int) -> [NewSportBean]{
        var lists = [NewSportBean]()
        let gidValue = item.keys.contains(gid) ? item[gid] as! String : ""
        let matchIdValue = item.keys.contains(matchId) ? item[matchId] as! String : ""
        let leagueValue = item.keys.contains(league) ? item[league] as! String : ""
     ...
     * @return
     */
    static func fillFootBallBC(item:Dictionary<String,AnyObject>,columns:Int) -> [NewSportBean]{
    ...
    //足球--波胆
    static func fillFootBallTI(item:Dictionary<String,AnyObject>,columns:Int) -> [NewSportBean]{
        var lists = [NewSportBean]()
        let gidValue = item.keys.contains(gid) ? item[gid] as! String : ""
        let matchIdValue = item.keys.contains(matchId) ? item[matchId] as! String : ""
        let leagueValue = item.keys.contains(league) ? item[league] as! String : ""
...
//            itemBean.teamNames = String.init(format: "%@      VS      %@", homeValue,guestValue)
     ...
     * @return
     */
    static func fillFootBallMX(item:Dictionary<String,AnyObject>,columns:Int,gameCategory:String) -> [NewSportBean] {
        var lists = [NewSportBean]()
        let gidValue = item.keys.contains(gid) ? item[gid] as! String : ""
        let matchIdValue = item.keys.contains(matchId) ? item[matchId] as! String : ""
        let leagueValue = item.keys.contains(league) ? item[league] as! String : ""
