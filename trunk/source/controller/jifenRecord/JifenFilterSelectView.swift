...
class JifenFilterSelectView: UIView {
    
    static let fixedTableViewRowHeight: CGFloat = 51.0

    var selectedIndex: Int = 0
    var didSelected: ( ( Int, JifenRow) -> Void)?
    var kLenny_InsideDataSource: [JifenRow]!
    ...
    convenience init(dataSource: [JifenRow], viewTitle: String) {
...
extension JifenFilterSelectView: UITableViewDelegate {
...
extension JifenFilterSelectView: UITableViewDataSource {
