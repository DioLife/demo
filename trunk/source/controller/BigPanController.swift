...
class BigPanController: BaseController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,
BigPanFooterDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForFooterInSection section: Int) -> CGSize {
        return CGSize.init(width: kScreenWidth, height: 250)
    }
    ...
    func addFooterContent() -> UIView {
        if footerView == nil{
            ...
            if let view = footerView{
                ...
                view.delegate = self
                view.frame = CGRect.init(x: 0, y: 10, width: kScreenWidth, height: 250)
                view.awardView.layer.cornerRadius = 3
                view.startBtn.layer.cornerRadius = 3
                view.toastView.layer.cornerRadius = 3
