//
//  UserWithdrawBankSelectCell.swift
//  gameplay
//
...
class UserWithdrawBankSelectCell: UITableViewCell {
    var isSelect = false
    ...
    func cellTransferType() -> (Int, String) {
        ...
        return (selectedIndex, bankCardModel[selectedIndex].bankCardNumber)
    }
    ...
    private func showSelectedView() {
        ...
        let selectedView = LennySelectView(dataSource: [bankCardModel[0].bankCardNumber, bankCardModel[1].bankCardNumber], viewTitle: "银行卡选择")
