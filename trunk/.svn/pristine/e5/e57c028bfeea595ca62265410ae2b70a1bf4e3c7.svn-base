//
//  TuanDuiZongLanController.swift
//  gameplay
//
...
class TuanDuiZongLanController: LennyTableViewController {
    ...
    override var cells: [UITableViewCell] {
        ...
        let cell4 = TuanDuiZongLanCell.init(style: .default, reuseIdentifier: "cell")
        array.append(cell4)
    ...
    override func tableHeaderViewWith(title: String) -> UIView? {
        return super.tableHeaderViewWith(title: "团队详情")
    }
}
