        ...
        for item in resultData {
            if item.icon != nil{
                print(item.cpName!,"\t\t\t",item.czCode!,"\t",item.ago!,"\t",
                      ...
                      item.lotVersion!,"\t\t\t\t",item.num!,"\t\t\t",item.icon!)
            }
        }
    }
...
//        if exsit == 0 || exsit == nil {//如果没在数据库中
//            if selecdedIndexs.contains(indexPath.row){ //但在选中列表中
//                cell?.accessoryType = .checkmark //右边选中 状态的标记
//            }else{//又没在选中列表中
//                cell?.accessoryType = .none
//            }
//        }else{//如果在数据库中
//            if deletedInDB.contains(indexPath.row){ // 但从列表中已经取消过一次了
//                cell?.accessoryType = .none //右边选中 状态的标记
//            }else{
//                cell?.accessoryType = .checkmark //右边选中 状态的标记
//                tableView.selectRow(at: indexPath, animated: true, scrollPosition:UITableViewScrollPosition.none)
//            }
//
//            if selecdedIndexs.contains(indexPath.row){ //在选中列表中
//                cell?.accessoryType = .checkmark //右边选中 状态的标记
//            }
//        }
...
//        var mybool = false
//        var myIndes = 0
//        for index in 0..<selectedRowNums.count {
//            if selecdedIndexs[index] == indexPath.row {
//                myIndes = index
//                mybool = true
//            }
//        }
//        if mybool {
//            selectedRowNums.remove(at: myIndes)//把本次选中列表中的 该项取消
//        }
        
//        把取消过的所有cell 序号存进数组
//        if !deletedInDB.contains(indexPath.row){
//            deletedInDB.append(indexPath.row)
//        }
    }
