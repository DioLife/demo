...
class LhcSpecialChooseDialog: UIView {
    ...
    var didSelected: ( ( Int, LHCSpecialData) -> Void)?
    var kLenny_InsideDataSource: [LHCSpecialData]!
    ...
    convenience init(dataSource: [LHCSpecialData], viewTitle: String) {
...
extension LhcSpecialChooseDialog: UITableViewDelegate {
...
extension LhcSpecialChooseDialog: UITableViewDataSource {
