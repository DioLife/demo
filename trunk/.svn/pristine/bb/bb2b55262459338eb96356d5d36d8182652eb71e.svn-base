...
//        self.addSubview(blurVisualEffect)
    ...
    private func commonInitialization() {
        setViewBackgroundColorTransparent(view: closeButton)
        ...
        for (index, imageView) in pageViews.enumerated() {
            for i in 0..<Int(rows * rowCount) {
                ...
                if banner.tag < items.count {
                    ...
                    banner.label.theme_textColor = "FrostedGlass.normalDarkTextColor"
                }
    ...
    @objc func itemSelected(_ sender: UITapGestureRecognizer) {
...
//        }
    ...
    @objc func fullTapped(_ sender: UITapGestureRecognizer) {
