...
//        pageTitleView.backgroundColor = self.layout.titleViewBgColor
        setupNoPictureAlphaBgView(view: pageTitleView)
    ...
    private lazy var sliderLineView: UIView = {
        ...
        sliderLineView.theme_backgroundColor = "Global.themeColor"
    ...
    @objc private func doSomethingMethod() {
        self.refreshTableTitle(index: self.glt_currentIndex)
    }
    ...
    /** 刷新滚动标题视图 */
    private func refreshTableTitle(index: Int) {
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            for button in self.glt_buttons {
                if button.tag == index {
                    button.theme_setTitleColor("Global.themeColor", forState: .normal)
                }else {
//                    button.setTitleColor(NORMAL_BASE_COLOR, for: .normal)
...
//        currentButton.setTitleColor(layout.titleSelectColor, for: .normal)
        currentButton.theme_setTitleColor("FrostedGlass.homeTitleNormalTextColor", forState: .normal)
        upButton.theme_setTitleColor("FrostedGlass.homeTitleNormalTextColor", forState: .normal)
    }
...
//            nextButton.setTitleColor(nextColor, for: .normal)
            ...
            currentButton.theme_setTitleColor("FrostedGlass.homeTitleNormalTextColor", forState: .normal)
            nextButton.theme_setTitleColor("FrostedGlass.homeTitleNormalTextColor", forState: .normal)
        }
...
extension LTPageView: UIScrollViewDelegate {
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        refreshTableTitle(index: glt_currentIndex)
    }
