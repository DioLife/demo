...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        MyButtonNode * startButton = [[MyButtonNode alloc] initWithDefaultTexture:startDefault andTouchedTexture:startTouched];
        ...
        MyButtonNode * scoreButton = [[MyButtonNode alloc] initWithDefaultTexture:scoreDefault andTouchedTexture:scoreTouched];
        ...
        MyButtonNode * musicButton = [[MyButtonNode alloc] initWithDefaultTexture:musicDefault andTouchedTexture:musicTouched];
...
-(void) startButtonPressed {
    ...
    SKScene * myScene = [[MyGameScene alloc] initWithSize:self.size];
