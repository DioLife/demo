...
//        self.layer.borderWidth = 0.3
        ...
        indictor = UIImageView.init(frame: CGRect.init(x: self.bounds.width-20, y: self.bounds.height/2-6, width: 12, height: 12))
    ...
    func itemClickEvent(reg:UIPanGestureRecognizer) -> Void {
        switchIndictor()
