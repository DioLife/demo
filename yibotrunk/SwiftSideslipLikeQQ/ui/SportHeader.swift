...
//        self.backgroundColor = UIColor.white
        ...
        indictor = UIImageView.init(frame: CGRect.init(x: self.bounds.width - 22, y: (self.bounds.height)/2-6, width: 12, height:12))
    ...
    func onHeaderClickEvent(_ recongnizer: UIPanGestureRecognizer) {
