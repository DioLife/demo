 ...
 */
let lottery_identify_V1 = "1";
let lottery_identify_V2 = "2";
let lottery_identify_V3 = "3";
let lottery_identify_V4 = "4";
let lottery_identify_V5 = "5";
let lottery_identify_V6 = "6";

let WEISHU_STR = "万,千,百,十,个";

let YUAN_MODE = 100;//元
let JIAO_MODE = 110;//元角
let FEN_MODE = 111;//元角分

/**
 * 平台试玩账号
 */
let ACCOUNT_PLATFORM_TEST_GUEST = 6;
/**
 * 会员平台账号
 */
let ACCOUNT_PLATFORM_MEMBER = 1;


let WAIT_KAIJIAN_STATUS = 1;
let ALREADY_WIN_STATUS = 2;
let NOT_WIN_STATUS = 3;
let CANCEL_ORDER_STATUS = 4;
let ROLLBACK_SUCCESS_STATUS = 5;
let ROLLBACK_FAIL_STATUS = 6;
let EXCEPTION_KAIJIAN_STATUS = 7;
let ACCOUNT_CHANGE_RECORD_STATUS = 8;


//体育投注记录的记录类型
//所有
let RECORD_TYPE_ALL = 1;
//会员赢钱
let RECORD_TYPE_WIN = 2;
//未开奖
let RECORD_TYPE_UNBALANCE = 3;
//未成功
let RECORD_TYPE_REJECT = 4;
...
let ALL_BALL_CONSTANT = 0;
let FOOTBALL_CONSTANT = 1;
let BASCKETBALL_CONSTANT = 2;

/**
 1全输 2输一半 3平 4赢一半 5全赢
 */
let BALANCE_ALL_LOST = 1;
let BALANCE_HALF_LOST = 2;
let BALANCE_DRAW = 3;
let BALANCE_HALF_WIN = 4;
let BALANCE_ALL_WIN = 5;
...
let BALANCE_ERROR = 3;
//比赛腰斩
let BALANCE_CUT_GAME = 4;
//租户 手动结算
let BALANCE_AGENT_HAND_DONE = 5;
//比分网结算
let BALANCE_BFW_DONE = 6;

//赔率投注面板每行几项collectioncell
let DEFAULT_COLUMNS = 2
...
let home = "home";
let guest = "guest";
let homeCode = "homeCode";
let guestCode = "guestCode";
let league = "league";
...
let ior_HRC = "ior_HRC";
let CON_HRC = "CON_HRC";
let ior_HOUH = "ior_HOUH";
let CON_HOUH = "CON_HOUH";
let ior_HOUC = "ior_HOUC";
let CON_HOUC = "CON_HOUC";
let ior_RC = "ior_RC";
let scoreC = "scoreC";
let scoreH = "scoreH";
...
let FOOTBALL_PAGE = 0;
let BASKETBALL_PAGE = 1;

//体育-0，真人-1，电子-2代号
let SPORT_MODULE_CODE = 0;
let REAL_MODULE_CODE = 1;
let GAME_MODULE_CODE = 2;
let CAIPIAO_MODULE_CODE = 3;
let CHESS_MODULE_CODE = 4;


let PAY_METHOD_ONLINE = 0;
let PAY_METHOD_FAST = 1;
let PAY_METHOD_BANK = 2;

//主界面模版风格id
let OLD_CLASSIC_STYLE = 1;
let EASY_LIGHT_APP_STYLE1 = 2;
let E15_APP_STYLE2 = 3;
let NEW_APP_STYLE3 = 4;
let NEW_APP_STYLE4 = 5;
let NEW_APP_STYLE6 = 6;
let NEW_APP_STYLE7 = 7;
let NEW_APP_STYLE8 = 8;
let NEW_APP_STYLE9 = 9;
let NEW_APP_STYLE10 = 10;

let YHC_CODE = "ycp"
let TT_CODE = "tt"

//扫码付
let scanpayFilterArr = ["xianfengjuhe", "lebaifu", "sanyingpay", "huiyinpay", "smartCloud", "goldpayment", "sptpay", "mibaozf", "lingdianpay",
...
let shunpayFilterArr = ["pay511", "jbfu", "huitianfu", "mibaozf", "yunweipay", "shangyizhifu", "kuaifu858pay", "chengfupay", "zhhky", "zhihepay",
...
let straightFilterArr = [
    "jiandanfu", "xianfengjuheh5", "xianfengjuhe", "lebaifu", "sanyingh5pay", "huiyinh5pay",
...
// 不支持网银的版本
let wappayFilterArr = [
    "xianfengjuheh5", "sevensevenh5pay", "juhebossh5", "mibeih5", "shenfubaoh5", "aikulih5pay",
    ...
    "jiamanpay", "ludepayh5", "ziyoupay", "bingshanpay", "jinyangpayh5", "wufupayh5", "ruyipayh5"
];

let scanpanWithRedirectFilterArr = ["sanyingpay"];
let shenxiao_str = ["鼠","牛","虎","兔","龙","蛇","马","羊","猴","鸡","狗","猪"]

//充值或提款記錄狀態
// 未处理
let STATUS_UNTREATED = 1;
// 处理成功
let STATUS_SUCCESS = 2;
// 处理失败
let STATUS_FAILED = 3;
// 已取消
let STATUS_CANCELED = 4;
// 已过期
let STATUS_EXPIRED = 5;

let BROWER_TYPE_SAFARI = 0
let BROWER_TYPE_UC = 1
let BROWER_TYPE_QQ = 2
let BROWER_TYPE_GOOGLE = 3
let BROWER_TYPE_FIREFOX = 4
