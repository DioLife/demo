...
class PlayVideoVC: UIViewController {
    ...
    @objc func btnclick(_ sender: UIButton) {
        let url = URL(string: "http://cjimg.demaxiya.com/ljr5Ig5WT6LUlZDMQSfnzw27_AXy.mp4?e=1543584000&token=pdWiVNxb2DqpyUOFuE1N_VudRUqNehUfpM-Jzsnd:jpTRTNaNxPYSKULhrvrUZtlgzqg=")
