...
-(void)setUI:(BOOL)isbool{
    ...
    self.btn.frame = CGRectMake(ScreenWidth - 60 - 50, ScreenHeight - 60 -80, 60, 60);
}
//初始化界面
-(void)initUI{
    ...
    self.btn.frame = CGRectMake(ScreenWidth - 60 - 50, ScreenHeight - 60 - 80, 60, 60);
    //    self.btn.frame = CGRectMake(self.view.frame.size.width - 60 -50, self.view.frame.size.height - 60 -80, 60, 60);
...
//                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",args[0]]] options:nil completionHandler:nil];
                NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@",args[0]]];
